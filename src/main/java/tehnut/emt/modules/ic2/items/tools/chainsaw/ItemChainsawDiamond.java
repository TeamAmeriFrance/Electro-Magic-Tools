package tehnut.emt.modules.ic2.items.tools.chainsaw;
...
public class ItemChainsawDiamond extends ItemAxe implements IElectricItem {
	...
	public ItemChainsawDiamond() {
		...
		setUnlocalizedName(ModInformation.ID + ".module.ic2.chainsaw.diamond");
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(ModInformation.TEXLOC + "tools/chainsaw_diamond");
	}
