package amerifrance.emt.modules.ic2.tile.solars.dark;
...
public class TileTripleDarkSolar extends TileDarkSolar {

    public TileTripleDarkSolar() {
    ...
    public ItemStack getWrenchDrop(EntityPlayer entityPlayer) {
        return new ItemStack(IC2BlockRegistry.solars1, 1, 8);
    }
}
