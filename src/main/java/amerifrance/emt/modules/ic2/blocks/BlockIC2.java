...
public class BlockIC2 extends BlockContainer {
    ...
    protected BlockIC2(String unlocName, Material material) {
        super(material);
        setBlockName(ModInformation.ID + ".module.ic2." + unlocName);
    ...
    public IIcon getIcon(IBlockAccess access, int x, int y, int z, int side) {
        TileIC2 tile = (TileIC2) access.getTileEntity(x, y, z);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        TileIC2 tile = (TileIC2) world.getTileEntity(x, y, z);
        if (facing == 0)
            tile.facing = 2;
        else if (facing == 1)
            tile.facing = 5;
