...
public class ItemThorHammer extends ItemSword {
	...
	public ItemThorHammer() {
		...
		this.setUnlocalizedName(ModInformation.modid + ".module.base.hammer");
		this.setTextureName(ModInformation.texturePath + ":hammer/thorhammer");
	}
	...
	public void addInformation(ItemStack stack, EntityPlayer par2EntityPlayer, List list, boolean par4) {
		list.add(TextHelper.localize("tooltip.EMT.hammer.thor"));
	}
}
