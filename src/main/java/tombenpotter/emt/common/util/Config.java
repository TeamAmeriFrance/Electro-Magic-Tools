...
public class Config {
    ...
    public static void essentiasConfig() {
        /** EU Yield/Consumption modifier **/
        //Aer -  15,000  Aqua - 5,000  Ignis - 20,000  Ordo -  16,000  Perditio - 10,000  Terra - 2,000
    ...
    public static void valuesConfig() {
    ...
    public static void researchConfig() {
        /** Disable Researches **/
