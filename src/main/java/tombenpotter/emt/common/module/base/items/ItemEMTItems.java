...
public class ItemEMTItems extends Item {
    ...
    public void registerIcons(IIconRegister ri) {
        this.icon[0] = ri.registerIcon(ElectroMagicTools.texturePath + ":clusteruranium");
        this.icon[1] = ri.registerIcon(ElectroMagicTools.texturePath + ":crushedamber");
        this.icon[2] = ri.registerIcon(ElectroMagicTools.texturePath + ":purifiedamber");
        this.icon[3] = ri.registerIcon(ElectroMagicTools.texturePath + ":crushedcinnabar");
        this.icon[4] = ri.registerIcon(ElectroMagicTools.texturePath + ":purifiedcinnabar");
        this.icon[5] = ri.registerIcon(ElectroMagicTools.texturePath + ":thaumiumplate");
        this.icon[6] = ri.registerIcon(ElectroMagicTools.texturePath + ":lightningsummoner");
        this.icon[7] = ri.registerIcon(ElectroMagicTools.texturePath + ":feathermesh");
        this.icon[8] = ri.registerIcon(ElectroMagicTools.texturePath + ":glue");
        this.icon[9] = ri.registerIcon(ElectroMagicTools.texturePath + ":ducttape");
        this.icon[10] = ri.registerIcon(ElectroMagicTools.texturePath + ":rubberball");
        this.icon[11] = ri.registerIcon(ElectroMagicTools.texturePath + ":cardboard");
        this.icon[12] = ri.registerIcon(ElectroMagicTools.texturePath + ":feathercarboardwing");
        this.icon[13] = ri.registerIcon(ElectroMagicTools.texturePath + ":denseironsheet");
        this.icon[14] = ri.registerIcon(ElectroMagicTools.texturePath + ":taintedfeather");
        this.icon[15] = ri.registerIcon(ElectroMagicTools.texturePath + ":thaumiumWing");
    }
