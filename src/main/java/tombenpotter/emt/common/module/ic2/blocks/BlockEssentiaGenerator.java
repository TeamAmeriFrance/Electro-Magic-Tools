...
import tombenpotter.emt.common.module.ic2.tile.generators.TileEntityEssentiaGenerator;
...
public class BlockEssentiaGenerator extends BlockEMT {
    ...
    public void registerBlockIcons(IIconRegister ri) {
        ...
        this.top[0] = ri.registerIcon(ElectroMagicTools.texturePath + ":essentiagenerator/top");
        this.bottom[0] = ri.registerIcon(ElectroMagicTools.texturePath + ":essentiagenerator/top");
        this.side[0] = ri.registerIcon(ElectroMagicTools.texturePath + ":essentiagenerator/side");
    }
