...
public class ItemSolarHelmetRevealing extends ItemQuantumGoggles {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layerType) {
        return ElectroMagicTools.texturePath + ":textures/models/solarrevealinghelmet.png";
    }
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = iconRegister.registerIcon(ElectroMagicTools.texturePath + ":solarrevealinghelmet");
    }
}
