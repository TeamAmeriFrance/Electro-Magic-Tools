...
public class ItemOmnitoolIron extends ItemPickaxe implements IElectricItem
{
	...
	public boolean canHarvestBlock(Block block, ItemStack stack) {
		return Item.axeIron.canHarvestBlock(block) || Item.swordIron.canHarvestBlock(block) || Item.pickaxeIron.canHarvestBlock(block) || Item.shovelIron.canHarvestBlock(block) || Item.shears.canHarvestBlock(block);
	}
