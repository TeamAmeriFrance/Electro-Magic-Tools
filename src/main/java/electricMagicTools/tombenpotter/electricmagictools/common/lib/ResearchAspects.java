 ...
 ******************************************************************************/
package electricMagicTools.tombenpotter.electricmagictools.common.lib;
...
public class ResearchAspects
{
	...
	public static AspectList saxumGenerator = new AspectList().add(Aspect.EXCHANGE, 4).add(Aspect.STONE, 3);
