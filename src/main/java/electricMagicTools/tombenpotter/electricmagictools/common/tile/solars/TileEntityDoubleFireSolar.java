...
public class TileEntityDoubleFireSolar extends TileEntityEMT implements IWrenchable {

    private BasicSource energySource = new BasicSource(this, 10000, 3);
    ...
    public void updateEntity() {
        ...
        if (worldObj.provider.dimensionId == -1) {
            energySource.addEnergy(Config.doubleCompressedSolarOutput * 2);
        } else {
            if (tick-- == 0) {
                updateSunState();
                tick = 64;
