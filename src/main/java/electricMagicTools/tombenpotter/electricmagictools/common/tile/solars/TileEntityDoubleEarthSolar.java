...
public class TileEntityDoubleEarthSolar extends TileEntityEMT implements IWrenchable {

    private BasicSource energySource = new BasicSource(this, 10000, 2);
    ...
    public void updateEntity() {
        ...
        if (theSunIsVisible && this.yCoord <= 10) {
            energySource.addEnergy(Config.doubleCompressedSolarOutput * 2.5);
        } else if (theSunIsVisible) {
            energySource.addEnergy(Config.doubleCompressedSolarOutput);
        }
    }
