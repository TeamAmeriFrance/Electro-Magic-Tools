...
public class TileEntityTripleEarthSolar extends TileEntityEMT implements IWrenchable {

    private BasicSource energySource = new BasicSource(this, 1000000, 5);
    ...
    public void updateEntity() {
        ...
        if (theSunIsVisible && this.yCoord <= 10) {
            energySource.addEnergy(Config.tripleCompressedSolarOutput * 2.5);
