...
public class TileEntityIgnisGenerator extends TileEntityEMT {
    int x;
    int y;
    int z;
    ...
    public void updateEntity() {
        ...
        if (waitTime <= 0) {
            if ((!this.worldObj.isRemote) && (EssentiaHandler.drainEssentia(this, Aspect.FIRE, ForgeDirection.UNKNOWN, 8))) {
