...
public class ThaumonomiconResearch
{
	...
	public static void addResearchTab() {
		...
		LanguageRegistry.instance().addStringLocalization("tc.research_category.EMT", "Electro-Magic Tools");
	}
	...
	public static void addResearch() {
		...
		text = "1";
		research = new EMTResearchItem("Macerating Native Ore Clusters", "EMT", new AspectList(), 5, -7, 0, Items.getItem("smallGoldDust")).setRound().setAutoUnlock().registerResearchItem();
		research.setPages(new ResearchPage(text));
		...
		{
			text = "1";
			research = new EMTResearchItem("Tiny Uranium", "EMT", ResearchAspects.tinyUraniumResearch, -5, -5, 1, Items.getItem("Uran238")).setSecondary().setParentsHidden("Electric Magic Tools").setConcealed().registerResearchItem();
		...
		if (Config.potentiaGeneratorResearch == false)
		{
			if (Config.saxumGenResearch == false)
			{
				text = "1";
				research = new EMTResearchItem("Saxum Generator", "EMT", ResearchAspects.saxumGenerator, -3, 5, 1, new ItemStack(BlockRegistry.essentiaGens, 1, 4)).setSecondary().setParents("Potentia Generator").setConcealed().registerResearchItem();
				research.setPages(new ResearchPage(text), new ResearchPage(EMTPostInitRecipes.saxumGenerator));
			}
		}
		...
		{
			text = "1";
			research = new EMTResearchItem("UU-Matter Infusion", "EMT", ResearchAspects.uuMInfusion, 5, 5, 3, Items.getItem("UuMatterCell")).setParentsHidden("Electric Magic Tools").setConcealed().registerResearchItem();
